...
const ConnectWalletButton = () => {
  ...
  return (
    isConnected && (
      <Button
        className="rounded-none w-full bg-accent hover:bg-accent/80 text-background font-display disabled:bg-blueDarken/80 text-sm font-medium tracking-wider flex-center gap-2 "
        size={'lg'}
        disabled={
          !sdkHasLoaded ||
          !isConnected ||
